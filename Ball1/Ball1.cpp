...
// Ball1.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CBall1App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CBall1App::OnAppAbout)
...
CBall1App::CBall1App() noexcept
{
	...
	SetAppID(_T("Ball1.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CBall1App

CBall1App theApp;


// Инициализация CBall1App

BOOL CBall1App::InitInstance()
{
...
// Обработчики сообщений CBall1App
